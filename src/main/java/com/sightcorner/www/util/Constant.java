...
public class Constant {
	...
	static{
		//article
		ARTICLE_SINGLE_MAP.put("2009_08", new ArchiveVO("上海-苏州-周庄-西塘-乌镇-杭州", "OH, year!第一次的旅游啊，第一次搭那么远火车的旅游，两个背包客上路了。..."));
		ARTICLE_SINGLE_MAP.put("2009_10", new ArchiveVO("海南-三亚-蜈支洲岛", "国庆长假，我们的第二次旅游。出发海南了。不过提早十天买火车票，发现火车票已经卖光光了..."));
		ARTICLE_SINGLE_MAP.put("2010_01", new ArchiveVO("北京-哈尔滨-雪乡-蚌埠-黄山-南昌", "放寒假，火车票不好买，经历过海南之旅，我们懂得了要错开高峰期买火车票..."));
		ARTICLE_SINGLE_MAP.put("2010_08", new ArchiveVO("上海-世博会", "世博会，圈宝儿一直吵了要去，但是暑假时间都在跟着老师做项目..."));
		ARTICLE_SINGLE_MAP.put("2010_10", new ArchiveVO("桂林-龙脊梯田-漓江-西街", "十一拉又到十一啦，众所周知，到十一，火车票就是一票难求啊，坑爹的火车票啊。..."));
		ARTICLE_SINGLE_MAP.put("2011_02", new ArchiveVO("西安-壶口-嵩山少林-白马寺-龙门石窟", "主页君偷懒了，看图片想故事的发生吧。"));
		ARTICLE_SINGLE_MAP.put("2011_06", new ArchiveVO("厦门-鼓浪屿", "依旧是以火车开始我们的旅程，到达了厦门的一刻，倒模般的高楼大厦，络绎的人群，实在很难..."));
		ARTICLE_SINGLE_MAP.put("2011_09", new ArchiveVO("成都-乐山大佛-峨眉山-九寨沟-重庆", "主页君偷懒了，看图片想故事的发生吧。"));
		...
		ARTICLE_SINGLE_MAP.put("2021_10", new ArchiveVO("新疆-乌鲁木齐-禾木-喀纳斯-可可托海","秋天的新疆很美，这里也是防疫和安全天花板，虽然变化了几次，但还是运气不错的..."));
		ARTICLE_SINGLE_MAP.put("2022_10", new ArchiveVO("青岛-泰山-济南","来青岛的第一天，树莓是广州飞青岛，我是从杭州飞青岛。青岛机场集合..."));
